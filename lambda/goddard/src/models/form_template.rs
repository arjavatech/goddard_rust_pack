...
pub struct FormTemplate {
    ...
    pub pdf_content_type: Option<String>,
    pub pdf_file_size_bytes: Option<i64>,
    pub pdf_uploaded_at: Option<NaiveDateTime>,
...
impl From<FormTemplate> for FormTemplateResponse {
    fn from(form_template: FormTemplate) -> Self {
        Self {
            ...
            pdf_file_name: form_template.pdf_file_name,
            pdf_content_type: form_template.pdf_content_type,
            pdf_file_size_bytes: form_template.pdf_file_size_bytes,
